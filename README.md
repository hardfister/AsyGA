...
### DPFedPalm (SOTA)
| | NIR | Red | Green | Blue | **Average** |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **NIR** | 0.0206 | 0.0553 | 0.2151 | 0.2291 | **0.1300** |
| **Red** | 0.0553 | 0.0200 | 0.0708 | 0.0729 | **0.0547** |
| **Green**| 0.2151 | 0.0708 | 0.0250 | 0.0302 | **0.0853** |
| **Blue** | 0.2291 | 0.0729 | 0.0302 | 0.0231 | **0.0888** |
| **Average**| **0.1300** | **0.0547** | **0.0853** | **0.0888** | **0.0897** |

### OURS
| | NIR | Red | Green | Blue | **Average** |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **NIR** | 0.0065 | 0.0153 | 0.1044 | 0.1263 | **0.0631** |
| **Red** | 0.0153 | 0.0065 | 0.0212 | 0.0245 | **0.0169** |
| **Green**| 0.1044 | 0.0212 | 0.0091 | 0.0102 | **0.0362** |
| **Blue** | 0.1263 | 0.0245 | 0.0102 | 0.0089 | **0.0425** |
| **Average**| **0.0631** | **0.0169** | **0.0362** | **0.0425** | **0.0397** |
